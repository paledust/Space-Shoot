...
public class Control : MonoBehaviour {
	...
	void Move()
	{
		...
		velocity = Vector3.Lerp(velocity, idealVel, Time.deltaTime);
	...
	void Shoot()
	{
		...
		new_Bullet.GetComponent<Rigidbody2D>().velocity = transform.rotation * Vector2.up * 100.0f;
		Debug.Log(new_Bullet.GetComponent<Rigidbody2D>().velocity);
	}
}
